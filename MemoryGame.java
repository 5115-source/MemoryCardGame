...
public class MemoryGame{
    ...
    public static boolean flipped(int[][] hiddenValues, char[][] board, Scanner input){
        ...
        while(matchedPairs < totalPairs){
          ...
          System.out.println("Flip the first card, enter row and col numbers 1-10");
          int rNum1 = input.nextInt();
          int cNum1 = input.nextInt();

          System.out.println("Flip the second card, enter row and col numbers 1-10: ");
          int rNum2 = input.nextInt();
          int cNum2 = input.nextInt();
